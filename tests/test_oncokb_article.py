def test_oncokb_article():
    ...
    csv_file = "tests/" + directory_name + "/data_oncokb_article.csv"
    table = pd.read_csv(csv_file)

    logging.debug("Load mapping...")
    mapping_file = "tests/" + directory_name + "/oncokb_article.yaml"
