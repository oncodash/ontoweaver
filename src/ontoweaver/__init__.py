...
def weave(biocypher_config_path, schema_path, filename_to_mapping, parallel_mapping = 0, separator = None, affix = "none", affix_separator = ":", validate_output = False, raise_errors = True, **kwargs):
        ...
        for loader in [lpf, lpd, lrf, lrg]:
            if loader.allows(data_file):
                ...
                adapter = loader.adapter()(
                    ...
                    *mapping,
                    type_affix=affix,
                    type_affix_separator=affix_separator,
