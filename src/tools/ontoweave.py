...
if __name__ == "__main__":
    ...
    do = jsonargparse.ArgumentParser(
        ...
        epilog = f"Example usage:\n  {appname} table.csv:mapping.yaml\n  {appname} --config biocypher_config.yaml --schema schema.yaml table1.csv:mapping1.yaml table2.tsv:mapping1.yaml table3.parquet:mapping2.yaml --import-script-run",
